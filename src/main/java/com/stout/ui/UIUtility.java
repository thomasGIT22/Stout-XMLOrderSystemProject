...
public class UIUtility {
     ...
     *
     * @param prompt the prompt text for the user
     * @param notDateMessage the error message for not a date
     * @return the int entered
     */
    public static LocalDate getUserDate(String prompt, String notDateMessage){
        Scanner in = new Scanner(System.in);
        ...
        while(needed){
            ...
            try{
                ...
                showErrorMessage(notDateMessage, true);
            }
        }
        return date;
    }
